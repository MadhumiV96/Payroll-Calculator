...
namespace PayrollApplication {
    ...
    public partial class PayrollSystemDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class tblPayRecordsDataTable : global::System.Data.TypedTableBase<tblPayRecordsRow> {
            ...
            private global::System.Data.DataColumn columnNextPay;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public global::System.Data.DataColumn NextPayColumn {
                get {
                    return this.columnNextPay;
                }
            }
            ...
            internal void InitVars() {
                ...
                this.columnNextPay = base.Columns["NextPay"];
            }
            ...
            private void InitClass() {
                ...
                this.columnNextPay = new global::System.Data.DataColumn("NextPay", typeof(decimal), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnNextPay);
                ...
                this.columnNextPay.AllowDBNull = false;
            }
        ...
        public partial class tblPayRecordsRow : global::System.Data.DataRow {
            ...
            public decimal TotalDeduction {
                get {
                    return ((decimal)(this[this.tabletblPayRecords.TotalDeductionColumn]));
                }
                set {
                    this[this.tabletblPayRecords.TotalDeductionColumn] = value;
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public decimal NextPay {
                get {
                    return ((decimal)(this[this.tabletblPayRecords.NextPayColumn]));
                }
                set {
                    this[this.tabletblPayRecords.NextPayColumn] = value;
                }
            }
        }
...
namespace PayrollApplication.PayrollSystemDBDataSet1TableAdapters {
    ...
    public partial class tblPayRecordsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_NextPay", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "NextPay", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tblPayRecords] ([EmployeeID], [FullName], [NINumber], [PayDate], [PayPeriod], [PayMonth], [HourlyRate], [ContractualHours], [OverTimeHours], [TotalHours], [ContractualEarnings], [OverTimeEarnings], [TotalEarnings], [TaxCode], [TaxAmount], [NIContribution], [UnionFee], [SLC], [TotalDeduction], [NextPay]) VALUES (@EmployeeID, @FullName, @NINumber, @PayDate, @PayPeriod, @PayMonth, @HourlyRate, @ContractualHours, @OverTimeHours, @TotalHours, @ContractualEarnings, @OverTimeEarnings, @TotalEarnings, @TaxCode, @TaxAmount, @NIContribution, @UnionFee, @SLC, @TotalDeduction, @NextPay);
SELECT PaymentID, EmployeeID, FullName, NINumber, PayDate, PayPeriod, PayMonth, HourlyRate, ContractualHours, OverTimeHours, TotalHours, ContractualEarnings, OverTimeEarnings, TotalEarnings, TaxCode, TaxAmount, NIContribution, UnionFee, SLC, TotalDeduction, NextPay FROM tblPayRecords WHERE (PaymentID = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@NextPay", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "NextPay", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblPayRecords] SET [EmployeeID] = @EmployeeID, [FullName] = @FullNa" +
                ...
                "duction] = @TotalDeduction, [NextPay] = @NextPay WHERE (([PaymentID] = @Original" +
                ...
                "tion] = @Original_TotalDeduction) AND ([NextPay] = @Original_NextPay));\r\nSELECT " +
                ...
                "Deduction, NextPay FROM tblPayRecords WHERE (PaymentID = @PaymentID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@NextPay", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "NextPay", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_NextPay", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "NextPay", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT PaymentID, EmployeeID, FullName, NINumber, PayDate, PayPeriod, PayMonth, HourlyRate, ContractualHours, OverTimeHours, TotalHours, ContractualEarnings, OverTimeEarnings, TotalEarnings, TaxCode, TaxAmount, NIContribution, UnionFee, SLC, TotalDeduction, NextPay FROM dbo.tblPayRecords";
        ...
        public virtual int Delete(
            ...
            this.Adapter.DeleteCommand.Parameters[19].Value = ((decimal)(Original_TotalDeduction));
            this.Adapter.DeleteCommand.Parameters[20].Value = ((decimal)(Original_NextPay));
        ...
        public virtual int Insert(
            ...
            this.Adapter.InsertCommand.Parameters[18].Value = ((decimal)(TotalDeduction));
            this.Adapter.InsertCommand.Parameters[19].Value = ((decimal)(NextPay));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[18].Value = ((decimal)(TotalDeduction));
            this.Adapter.UpdateCommand.Parameters[19].Value = ((decimal)(NextPay));
            ...
            this.Adapter.UpdateCommand.Parameters[39].Value = ((decimal)(Original_TotalDeduction));
            this.Adapter.UpdateCommand.Parameters[40].Value = ((decimal)(Original_NextPay));
        ...
        public virtual int Update(
                    ...
                    decimal Original_TotalDeduction, 
                    decimal Original_NextPay) {
            return this.Update(EmployeeID, FullName, NINumber, PayDate, PayPeriod, PayMonth, HourlyRate, ContractualHours, OverTimeHours, TotalHours, ContractualEarnings, OverTimeEarnings, TotalEarnings, TaxCode, TaxAmount, NIContribution, UnionFee, SLC, TotalDeduction, NextPay, Original_PaymentID, Original_EmployeeID, Original_FullName, Original_NINumber, Original_PayDate, Original_PayPeriod, Original_PayMonth, Original_HourlyRate, Original_ContractualHours, Original_OverTimeHours, Original_TotalHours, Original_ContractualEarnings, Original_OverTimeEarnings, Original_TotalEarnings, Original_TaxCode, Original_TaxAmount, Original_NIContribution, Original_UnionFee, Original_SLC, Original_TotalDeduction, Original_NextPay, Original_PaymentID);
        }
    }
